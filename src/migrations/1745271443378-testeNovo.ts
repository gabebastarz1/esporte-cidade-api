...
export class TesteNovo1745271443378 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "enrollment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "active" boolean NOT NULL DEFAULT (0), "approved" boolean NOT NULL DEFAULT (0), "created_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updated_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "athleteId" integer, "modalityId" integer)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_enrollment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "active" boolean NOT NULL DEFAULT (0), "approved" boolean NOT NULL DEFAULT (0), "created_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updated_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "athleteId" integer, "modalityId" integer, CONSTRAINT "FK_9da60bd721aae7b35c89b448751" FOREIGN KEY ("athleteId") REFERENCES "athlete" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_df014b705a2c5dff9da9ba54c54" FOREIGN KEY ("modalityId") REFERENCES "modality" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_enrollment"("id", "active", "approved", "created_at", "updated_at", "athleteId", "modalityId") SELECT "id", "active", "approved", "created_at", "updated_at", "athleteId", "modalityId" FROM "enrollment"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "enrollment" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "active" boolean NOT NULL DEFAULT (0), "approved" boolean NOT NULL DEFAULT (0), "created_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "updated_at" date NOT NULL DEFAULT (CURRENT_TIMESTAMP), "athleteId" integer, "modalityId" integer)`);
        await queryRunner.query(`INSERT INTO "enrollment"("id", "active", "approved", "created_at", "updated_at", "athleteId", "modalityId") SELECT "id", "active", "approved", "created_at", "updated_at", "athleteId", "modalityId" FROM "temporary_enrollment"`);
