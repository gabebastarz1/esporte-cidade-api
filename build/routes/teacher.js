...
var teacherRepository = config_1.AppDataSource.getRepository(teacher_entity_1.Teacher);
router
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, teacherRepository.find({
                        relations: ["modality"],
                    })];
            case 1:
                teachers = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Erro ao buscar professores:", error_1.message);
                console.error(error_1.stack);
                res.status(500).json({ message: "Erro ao buscar professores.", error: error_1.message });
                return [3 /*break*/, 3];
    ...
    var teacherId, teacher, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                teacherId = parseInt(req.params.id, 10);
                if (isNaN(teacherId)) {
                    return [2 /*return*/, res.status(400).json("ID de professor inválido.")];
                }
                return [4 /*yield*/, teacherRepository.findOneBy({ id: teacherId })];
            case 1:
                teacher = _a.sent();
                if (!teacher) {
                    return [2 /*return*/, res.status(404).json("Professor não encontrado.")];
                }
                res.status(200).json(teacher);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                console.error("Erro ao buscar professor:", error_2);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                teacher = teacherRepository.create(__assign(__assign({}, req.body), { role: roles_enum_1.Roles.TEACHER }));
            ...
            case 2:
                error_3 = _a.sent();
                console.error("Erro ao criar professor:", error_3);
    ...
    var teacherId, teacher, _a, error_4;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a.password = _b.sent(); // Criptografando a nova senha
                _b.label = 3;
            case 3: return [4 /*yield*/, teacherRepository.save(teacher)];
            case 4:
                _b.sent();
                res.status(200).json(teacher);
                return [3 /*break*/, 6];
            case 5:
                error_4 = _b.sent();
                console.error("Erro ao atualizar professor:", error_4);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, teacherRepository.remove(teacher)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_5 = _a.sent();
                console.error("Erro ao deletar professor:", error_5);
