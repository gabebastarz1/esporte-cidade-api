...
var userRepository = config_1.AppDataSource.getRepository(user_base_entity_1.UserBase);
router
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.error("Erro ao buscar usuários:", error_1.message);
                console.error(error_1.stack);
                res
                    .status(500)
                    .json({ message: "Erro ao buscar usuários.", error: error_1.message });
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (isNaN(userId)) {
                    return [2 /*return*/, res.status(400).json("ID de usuário inválido.")];
                }
                return [4 /*yield*/, userRepository.findOneBy({ id: userId })];
            case 1:
                user = _a.sent();
                if (!user) {
                    return [2 /*return*/, res.status(404).json("Usuário não encontrado.")];
                }
                res.status(200).json(user);
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                console.error("Erro ao buscar usuário:", error_2);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                user = userRepository.create(__assign(__assign({}, req.body), { password: hashedPassword, role: req.body.role || roles_enum_1.Roles.ATHLETES }));
            ...
            case 3:
                error_3 = _a.sent();
                console.error("Erro ao criar usuário:", error_3);
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                _a.password = _b.sent();
                _b.label = 3;
            case 3: return [4 /*yield*/, userRepository.save(user)];
            case 4:
                _b.sent();
                res.status(200).json(user);
                return [3 /*break*/, 6];
